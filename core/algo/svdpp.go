...
func (pp *SVDPP) Fit(trainData data.Set, options ...OptionsEditor) {
	// 设置参数
	option := Option{
		nFactors:   20,
		nEpoch:     20,
	...
	users, items, ratings := trainData.AllInteraction()
